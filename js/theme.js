    ...
    return function (e) {
        ...
        return o.m = e, o.c = r, o.d = function (e, r, t) {
            ...
            if (o.r(t), Object.defineProperty(t, "default", {
                ...
                for (var i in e) o.d(t, i, function (r) {
                    return e[r]
                }.bind(null, i));
            return t
        }, o.n = function (e) {
        ...
        var i = /#(?:[0-9a-fA-F]{3}){1,2}/,
            ...
            a = {
                ...
                sidebar_background: "#2196f3",
                card_background: "#fff",
                highlight: [
                    '#263238', '#2c393f', '#37474f', '#707880',
                    '#c9ccd3', '#cdd3de', '#d5dbe5', '#ffffff',
                    '#ec5f67', '#ea9560', '#ffcc00', '#8bd649',
                    '#80cbc4', '#89ddff', '#82aaff', '#ec5f67'
                ]
            },
        ...
        function l(e) {
            ...
            return o.push(c.background.replace(/BACKGROUND/g, r.background), c.accent_color.replace(/COLOR_005/g, "rgba(" + l.r + "," + l.g + "," + l.b + ",.05)").replace(/COLOR_01/g, "rgba(" + l.r + "," + l.g + "," + l.b + ",.1)").replace(/COLOR_02/g, "rgba(" + l.r + "," + l.g + "," + l.b + ",.2)").replace(/COLOR_04/g, "rgba(" + l.r + "," + l.g + "," + l.b + ",.4)").replace(/COLOR_08/g, "rgba(" + l.r + "," + l.g + "," + l.b + ",.8)").replace(/COLOR/g, l.hex).replace(/SIDEBAR_BACKGROUND/g, g(r.sidebar_background))), r.content_width && o.push(c.content_width.replace(/CONTENT_WIDTH/g, r.content_width)), o.push(s(c.highlight.base, r.highlight)), p(r.card_background, r.highlight[0]) || p(r.highlight[15], r.highlight[0]) ? p(r.card_background, r.highlight[1]) || p(r.highlight[15], r.highlight[1]) ? o.push(c.highlight.bordered_mix) : o.push(s(c.highlight.bordered, r.highlight)) : (p(r.card_background, r.highlight[1]) && (r.highlight[1] = r.highlight[0]), o.push(s(c.highlight.flat, r.highlight))), o.join("")
        }
        ...
        function _(e) {
            return (e.default || e).toString().replace('@charset "UTF-8";', "")
        }
