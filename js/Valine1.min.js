...
! function (e, t) {
	...
	return function (e) {
		...
		"use strict";
		t.__esModule = !0;
		t.DEFAULT_EMOJI_CDN = "//cdn.jsdelivr.net/gh/xaoxuu/cdn-assets/emoji/valine/", t.DB_NAME = "Comment", t.defaultConfig = {
			lang: "zh-CN",
			langMode: null,
			appId: "",
			appKey: "",
			...
			try {
				...
				if (p = p instanceof HTMLElement ? p : f[f.length - 1] || null) {
					...
					var v = (0 == e.config.meta.length ? h.defaultMeta : e.config.meta).map(function (t) {
						...
						return h.defaultMeta.indexOf(t) > -1 ? '<input name="' + t + '" placeholder="' + (e.config.metaPlaceholder[t] || e.i18n.t(t)) + '" class="v' + t + ' vinput" type="' + n + '">' : ""
					}),
		...
		o.prototype.Q = function (e) {
			...
			var C = function (t, n, r) {
				var o = (0, y.default)('<div class="vcard" id="' + t.id + '"></div>'),
					i = t.get("ua"),
					a = "";
				i && !/ja/.test(e.config.lang) && (i = y.default.detect(i), a = '<span class="vsys"><i class="fab fa-' + (["xiaomi"].includes(i.browser.toLowerCase()) ? "mobile-alt fas" : i.browser.toLowerCase()) + '"></i>' + i.browser + " " + i.version + "</span>" + " " + ('<span class="vsys"><i class="fab fa-' + (["mac os", "ios"].includes(i.os.toLowerCase()) ? "apple" : i.os.toLowerCase()) + '"></i>' + i.os + " " + i.osVersion + "</span>")), "*" === e.config.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
				...
				var qqm = t.get("mail").match(/([\d]+)@(vip\.)?qq.com/),
					qqa = qqm ? "https://q2.qlogo.cn/headimg_dl?dst_uin=" + qqm + "&spec=100" : null,
